...
- [ ] Clean `npm ci` on Node 22.13+ and every verification command passes without warnings.
- [ ] Independent Solidity and Clarity/security review completed; known findings documented.
...
- [ ] Talent contest rules and eligibility rechecked at submission time; no readiness document treated as acceptance.
